...
const CardMobile = (props: CardMobileProps) => {
  const { imageUrl, title, shortDescription } = props;
  return (
    <Stack
      direction="row"
      alignItems="center"
    ...
    <Stack mb={{md: 8, xs: 2}}>
      <Stack direction="row" justifyContent="space-between" alignItems="center">
        ...
        <Stack direction="row" alignItems="center" spacing={1}>
          <Text fontSize={{md: 16, xs: 12}} fontWeight={500}>Recent</Text>
          <MaterialUISwitch/>
          <Text fontSize={{md: 16, xs: 12}} fontWeight={500}>Popular</Text>
        </Stack>
      </Stack>
