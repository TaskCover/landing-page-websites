                    ...
                    >
                        {
                            ListPolicies.map((item, index) => (
                                <Stack p="16px 24px" key={index} onClick={() => setTabActive(item)}
                                    sx={{
                ...
                >
                    ...
                    <Stack>
                        ...
                        <Text sx={[textDescSx,]} fontWeight={500}>
                            If you do not agree to our use of your personal data in line with this policy, please do not use the ClickUp Services.
                        </Text>
                        <Text sx={[textLabelSx,]} >
                            Scope of this Privacy Policy
                        </Text>
                        <Text sx={[textDescSx,]}>
                            Please be aware that this Privacy Policy does not govern all the information ClickUp may process. Our commitment to customers and service providers is governed by a separate Data Protection Addendum. This Privacy Policy is also incorporated into and governed by our Terms of Use.<br />Any capitalized words we use in this Privacy Policy that we haven’t defined here will have the same meaning that they’re given in our Terms of Use.
                            Our commitments to employees are governed by our internal employment policies.<br />
                        ...
                        Depending on your use of the ClickUp Service, we collect two types of information:personally identifiable information and non-personally identifiable information. ${<br />}
