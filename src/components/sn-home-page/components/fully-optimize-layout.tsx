...
const FullyObtimizeLayout = (props: FullyObtimizeLayoutProps) => {
    return (
        <Stack width="100%" sx={{ background: "linear-gradient(180deg, rgba(87, 161, 202, 0.23) 0%, rgba(255, 255, 255, 0.00) 100%)" }}>
            <Stack
            ...
            >
                ...
                >
                    <Image src={FullOptimizeImg} alt="image line" style={{ width: "100%", height: "auto" }} />
                    <Stack gap="16px">
