                                    ...
                                    <Stack flexDirection="row" justifyContent={{ xs: "center", md: "none" }} gap="8px">
                                        {item.items.map(i => (
                                            <Stack
                                                ...
                                                alignItems="center"
                                                width={i.isBigIcon ? { xs: "120px", md: "200px" } : { xs: "60px", md: "100px" }}
                                                sx={{ background: "linear-gradient(282deg, rgba(160, 197, 253, 0.10) 0%, rgba(162, 199, 255, 0.20) 100%)" }}
                                            >
                                                <Image
                                                    src={i.imgUrl}
                                                    ...
                                                    alt="image"
                                                />
                                                <Text variant="caption" fontWeight={400} color="#374151" style={{ textAlign: "center" }}>
                                                    {i.label}
                                                </Text>
                                            </Stack>
                                        ))
                        ...
                        <Stack
                            ...
                            <Stack>
                                ...
                                <Stack flexDirection="row" alignItems="center">
                                    <Text variant="h2" fontSize={{ xs: "24px", md: "36px" }} color="#fff">
                                        $
                                    </Text>
                                    <Text variant={{ xs: "h3", md: "h1" }} fontSize={{ xs: "48px", md: "60px" }} lineHeight="44px" color="#fff">
                                        19.00/
                                    </Text>
                                    <Text variant={{ xs: "h4", md: "h3" }} fontWeight={700} color="#fff">
                                        Per User
                                    </Text>
                                </Stack>
                            ...
                            <Stack flexDirection="row" gap={{ xs: "12px", md: "16px" }} alignItems="center">
                                <Button sx={{ width: { xs: "120px", md: "180px" }, background: "#fff", color: "#000", fontSize: "16px", borderRadius: "24px", p: "6px 12px" }}>
                                    See pricing
                                </Button>
                                <Button sx={{ width: { xs: "120px", md: "180px" }, border: "1px solid #fff", color: "#fff", fontSize: "16px", borderRadius: "24px", p: "6px 12px" }}>
                                    Explore function
                                </Button>
                            </Stack>
                        </Stack>
