      ...
      <Stack width="100%" sx={{}}>
        <Stack sx={sectionContainerSx}>
          ...
          <Stack mt={{ xs: "48px", md: "64px" }} width="100%">
            <Stack
              ...
              sx={{
                borderRadius: "12px",
                background:
                  " linear-gradient(90deg, #0575E6 5.8%, #38E27B 55.38%)",
              }}
            >
              <Stack
                position="absolute"
                sx={{ top: "20px", right: { xs: "-8px", md: "-15px" } }}
              >
                <Image
                  src={RecomendedPlagIc}
                  width={isMdSmaller ? 123 : 256}
                  alt={"image flag"}
                />
              </Stack>
              <Stack
              ...
              <Stack width={{ xs: "100%", md: "40%" }}>
                ...
                <Text
                  ...
                  sx={{ textTransform: "none" }}
                >
                  Perfect for small-to-medium enterprise to make
                  <br /> disruption in the industry
                </Text>
                <Stack
                  width="100%"
                  height="1px"
                  ...
                  my="16px"
                />
                <Stack gap="13px" mb="24px">
                  {[
                    "Every feature and unlimited storage",
                    "Ai agent usage",
                    "24/7 support",
                  ].map((e, i) => (
                    <Stack
            ...
            >
              ...
              >
                ...
                <Stack>
                  ...
                  >
                    Fit small team of 2 to 3 members who are looking <br /> to
                    optimize planning and executing projects
                  </Text>
                  <Stack
                    width="100%"
                    height="1px"
                  ...
                  <Stack gap="13px" mb="24px">
                    {[
                      "Experience all project management features",
                      "Access to AI agent",
                    ].map((e, i) => (
                      <Stack
                        key={i}
          ...
          <Preview
            ...
            src={
              "https://www.youtube.com/watch?v=ZHhqwBwmRkI&pp=ygUOdmlkZW8gbG9sIDIwMjQ%3D"
            }
          />
        </Stack>
      </Stack>
