...
const HeadLayout = (props: HeadLayoutProps) => {
    return (
        <Stack width="100%" sx={{
            ...
            <Stack
                sx={[sectionContainerSx, { p: { xs: "60px 16px 0px", md: "60px 0px 0px" } }]}
            >
                ...
                <Text variant="h4" fontWeight={400} color="#111827" my="24px" fontSize={{ xs: "16px", md: "20px" }} sx={{ textAlign: "center" }}>
