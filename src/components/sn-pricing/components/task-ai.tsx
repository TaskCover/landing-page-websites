            ...
            >
              ...
              <Stack>
                <Text component="span" sx={[textHeadSx]}>
                  TaskCover AI turns every{!isMdSmaller && <br />} task{" "}
                  {isMdSmaller && <br />}into optimization and excellence.
                </Text>
              </Stack>
              <Text
                variant="overline"
              ...
              >
                Revolutionize your workflow with AI precision. Elevate your
                potential – integrate AI into your progress today.
              </Text>
              <Button
                sx={{
