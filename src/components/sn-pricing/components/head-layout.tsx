        ...
        <Stack gap={{ xs: "40px", md: "60px" }} sx={sectionContainerSx}>
          ...
          >
            ...
            >
              ...
              <Stack>
                <Text component="span" sx={[textHeadSx]}>
                  Optimize Productivity via
                  <br />
                  <Text
                    component="span"
                    sx={{
                      ...
                      ...textGradientSx,
                      background:
                        "linear-gradient(90deg, #0575E6 110.8%, #38E27B 96.38%)",
                    }}
                  >
                    TaskCover
                  </Text>
                  : Choose the {isMdSmaller && <br />} perfect{" "}
                  {!isMdSmaller && <br />} plan that suits your needs
                </Text>
              </Stack>
              <Text
                variant="overline"
              ...
              >
                Optimize your progress. Select the best plan and enhance your
                experience today.
              </Text>
              <Button
                sx={{
          ...
          >
            {CardHeadData.map((card, index) => (
              ...
              >
                <Stack>
                  <Image src={card.imgUrl} alt="image" />
                  <Text
                    sx={{
                      color: "#7696E9",
                      fontSize: "16px",
