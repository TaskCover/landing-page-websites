...
import AccountInfoMobileHeader from "../../DrawerMobile/AccountInfoMobile/AccountInfoMobileHeader";
...
const StorageGroupInfoMobile = (props) => {
  return (
    <Box
      sx={{
        display: "flex",
...
export default StorageGroupInfoMobile;
