                ...
                {Boolean(formik.values["attachments"].length) ? (
                  ...
                  <Stack>
                    <Text
                      ...
                      fontSize={12}
                    >
                      Allow file doc, docx, xls, xlsx, ppt, pptx, pdf and up to
                      3mb
                    </Text>
                    <Text
                      variant="h6"
                  ...
                  {Boolean(formik.values["attachments"].length) ? (
                    ...
                    <Stack>
                      <Text
                        ...
                        fontSize={12}
                      >
                        Allow file doc, docx, xls, xlsx, ppt, pptx, pdf and up
                        to 3mb
                      </Text>
                      <Text
                        variant="h6"
...
const FieldContainer = ({ label, childField }) => {
  return (
    <Stack alignItems="start" gap="8px">
