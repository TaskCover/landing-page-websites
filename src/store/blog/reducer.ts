...
import { BlogData, CommentBlogData, createNewBlogs, getAllBlogs, getBlogBySlug, getBlogComments, getRelatedBlog } from "./actions";
...
export const blogSlice = createSlice({
    ...
    extraReducers(builder) {
        builder.addCase(
            ...
            }).addCase(getBlogComments.pending, (state, action) => {
                state.blogsStatus = DataStatus.LOADING;
